...
## export
write.csv(polyDF, file = "output/fw_countries_intersection.csv")
write.csv(data, file = "output/fw_countries_occurence.csv")
write.csv(data_m, file = "output/fw_countries_occurence_month.csv")
write.csv(data_year, file = "output/fw_countries_occurence_year.csv")
write.csv(country_intersect, file = "output/fw_N_selections_by_cntr.csv")
...
write.csv(sum, file = "output/fw_countries_intersection_year.csv")

write.csv(cntrAREA, file = "output/fw_countries_intersection_yearAREA.csv")

...
# Group by two features and calculate the count of organisations selected for each monthly interaction
feature_counts_fw <- data %>%
   group_by(org_name, ym) %>%
   summarise(count = n())
